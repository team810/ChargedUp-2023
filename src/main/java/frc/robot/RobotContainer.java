...
//   private final Intake m_intake = new Intake();
  ...
  public RobotContainer() {
    ...
    m_drivetrainSubsystem.setDefaultCommand(new DefaultDriveCommand(
            ...
            () -> modifyAxis(Constants.OIConstants.DRIVE_GAMEPAD.getLeftX()) * DrivetrainConstants.MAX_VELOCITY_METERS_PER_SECOND,
            () -> modifyAxis(Constants.OIConstants.DRIVE_GAMEPAD.getLeftY()) * DrivetrainConstants.MAX_VELOCITY_METERS_PER_SECOND,
            () -> modifyAxis(Constants.OIConstants.DRIVE_GAMEPAD.getRightX())* DrivetrainConstants.MAX_VELOCITY_METERS_PER_SECOND
    ));
...
//    );
    ...
    new Trigger(Constants.OIConstants.DRIVE_GAMEPAD::getXButton).whileTrue(new InstantCommand(arm::rest));

    new Trigger(Constants.OIConstants.DRIVE_GAMEPAD::getAButton).whileTrue(new InstantCommand(arm::lowGoal));
    new Trigger(Constants.OIConstants.DRIVE_GAMEPAD::getBButton).whileTrue(new InstantCommand(arm::middleGoal));
    new Trigger(Constants.OIConstants.DRIVE_GAMEPAD::getYButton).whileTrue(new InstantCommand(arm::highGoal));
